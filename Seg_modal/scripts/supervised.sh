...
method='supervised'
exp='r101'
split='Cityscapes_LIS_mask_pseudo_balance'
split='Cityscapes_LIS_mask_pseudo_balance_major'
split='Cityscapes_LIS_mask_pseudo_over_x5'

config=configs/${dataset}_sup_only.yaml
