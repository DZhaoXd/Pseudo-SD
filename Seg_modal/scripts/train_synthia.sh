...
dataset='cityscapes_16'
method='unimatch'
exp='r101'
split='DTST_synthia'
split='DTST_synthia_sam_vit_h'
split='DTST_synthia_sam_vit_h_filter'


config=configs/${dataset}.yaml
labeled_id_path=splits/cityscapes/$split/labeled.txt
unlabeled_id_path=splits/cityscapes/$split/unlabeled.txt
